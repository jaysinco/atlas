...
std::map<uint32_t, KeyCode::Data> KeyCode::key_mapping = {
    {KEY_TAB, {XK_Tab, XK_Tab, ImGuiKey_Tab, ImGuiKey_Tab, ' ', ' '}},
    ...
    {KEY_GRAVE, {XK_grave, XK_asciitilde, ImGuiKey_GraveAccent, ImGuiKey_GraveAccent, '`', '~'}},
    {KEY_MINUS, {XK_minus, XK_underscore, ImGuiKey_Minus, ImGuiKey_Minus, '-', '_'}},
    {KEY_EQUAL, {XK_equal, XK_plus, ImGuiKey_Equal, ImGuiKey_Minus, '=', '+'}},
    {KEY_LEFTBRACE, {XK_bracketleft, XK_braceleft, ImGuiKey_None, ImGuiKey_None, '[', '{'}},
    {KEY_RIGHTBRACE, {XK_bracketright, XK_braceright, ImGuiKey_None, ImGuiKey_None, ']', '}'}},
    {KEY_BACKSLASH, {XK_backslash, XK_bar, ImGuiKey_Slash, ImGuiKey_Slash, '\\', '|'}},
    {KEY_SEMICOLON, {XK_semicolon, XK_colon, ImGuiKey_Semicolon, ImGuiKey_Semicolon, ';', ':'}},
    {KEY_APOSTROPHE,
     {XK_apostrophe, XK_quotedbl, ImGuiKey_Apostrophe, ImGuiKey_Apostrophe, '\'', '"'}},
    {KEY_SLASH, {XK_slash, XK_question, ImGuiKey_Slash, ImGuiKey_Slash, '/', '?'}},
